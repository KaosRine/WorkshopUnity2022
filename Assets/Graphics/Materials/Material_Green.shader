...
Shader "Custom/MasterSurfaceShader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 color2 = IsGammaSpace() ? float4(0,0.8396226,0.008435054,0) : float4(0,0.673178,0.000652868,0);
...
/*ASEBEGIN
Version=17400
31;141;1882;878;1844.573;694.0708;1;True;False
Node;AmplifyShaderEditor.ColorNode;2;-1107,-524.5;Inherit;False;Constant;_AlbedoColor;Albedo Color;1;0;Create;True;0;0;False;0;0,0.8396226,0.008435054,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=53D2C6AFCAF807426AF66B5E7C5473B0F7E4F364