...
Shader "Custom/MasterSurfaceShader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 color2 = IsGammaSpace() ? float4(0,0,1,0) : float4(0,0,1,0);
...
/*ASEBEGIN
Version=17400
-1;1;968;1023;499.5735;262.5708;1;True;False
Node;AmplifyShaderEditor.ColorNode;2;-1107,-524.5;Inherit;False;Constant;_AlbedoColor;Albedo Color;1;0;Create;True;0;0;False;0;0,0,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=86B058D0DC591B492828F1E44A98B7192FC5688A