...
Shader "Custom/MasterSurfaceShader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 color2 = IsGammaSpace() ? float4(0,0.162251,1,0) : float4(0,0.02253733,1,0);
...
/*ASEBEGIN
Version=17400
0;0;1920;1019;1886.581;793.0956;1;False;False
Node;AmplifyShaderEditor.ColorNode;2;-1107,-524.5;Inherit;False;Constant;_AlbedoColor;Albedo Color;1;0;Create;True;0;0;False;0;0,0.162251,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=90F669758E1FA7649A375F96226C256D9C0942A7