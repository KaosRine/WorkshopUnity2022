...
Shader "Custom/MasterSurfaceShader"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float4 color2 = IsGammaSpace() ? float4(1,0.19515,0,0) : float4(1,0.0316137,0,0);
...
/*ASEBEGIN
Version=17400
31;141;1882;878;1844.573;691.0708;1;True;False
Node;AmplifyShaderEditor.ColorNode;2;-1107,-524.5;Inherit;False;Constant;_AlbedoColor;Albedo Color;1;0;Create;True;0;0;False;0;1,0.19515,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=06D92651AB2A6026CC8BAFC35EC7911615C295A0